    ...
    def configs(self) -> list[ModelConfig]:
        return [
            ModelConfig(
                ...
                params={"solver": "lbfgs", "penalty": "l2", "C": 1.0, "max_iter": 1000, "random_state": 42},
                task_types=_TASKS,
            ...
            ModelConfig(
                ...
                algorithm_family="LogisticRegression",
                params={"solver": "saga", "penalty": "l1", "C": 1.0, "max_iter": 1000, "random_state": 42},
                task_types=_TASKS,
                requires_scaling=True,
                supports_feature_importance=True,
                supports_shap=True,
            ...
            ModelConfig(
                ...
                algorithm_family="LogisticRegression",
                params={"solver": "saga", "penalty": "elasticnet", "l1_ratio": 0.5, "C": 1.0, "max_iter": 1000, "random_state": 42},
                task_types=_TASKS,
                requires_scaling=True,
                supports_feature_importance=True,
                supports_shap=True,
